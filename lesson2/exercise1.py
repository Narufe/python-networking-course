...
#each subnet starts at a multiple of this increment starting 
#from zero
subnet_increment = 2 ** host_bits

#number of hosts (after taking out subnet network address 
#and broadcoast addres address)
number_hosts = subnet_increment - 2

print(f"1. The number of hosts in the subnet: {number_hosts} \n")
...
print(f"{ip_addr}{subnet_increment-2}")
